...
import 'package:marvel/app/modules/personage/presenter/bloc/personage_bloc.dart';
...
void main() {
  ...
  group("teste do bloc fetch event", () {
    ...
    blocTest<PersonageBloc, PersonageState>(
      ...
      build: () => PersonageBloc(usecase: usecase),
      act: (bloc) async {
        when(() => usecase.call(params: params)).thenAnswer((invocation) async => Left(dataSourceError));
  ...
  group("teste do bloc paginate event", () {
    ...
    blocTest<PersonageBloc, PersonageState>(
      ...
      build: () => PersonageBloc(usecase: usecase),
      act: (bloc) async {
        when(() => usecase.call(params: params)).thenAnswer((invocation) async => Left(HttpClientError(
